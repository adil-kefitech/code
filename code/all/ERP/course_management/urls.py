...
from.import college_centre_transfer
from.import student_mapping
...
#-------------exam-time-table-view-----------------------------------------------------------
    ...
    path('student-mapping/',           student_mapping.StudentMappingPageLoad.as_view(),     name='student-mapping'),
    path('student-mapping/semesters/', student_mapping.StudentMappingSemesterList.as_view(), name='student-mapping-semesters'),
    path('student-mapping/preview/',   student_mapping.StudentMappingPreview.as_view(),      name='student-mapping-preview'),
    path('student-mapping/execute/',   student_mapping.StudentMappingExecute.as_view(),      name='student-mapping-execute'),
    path('student-mapping/batches/', student_mapping.StudentMappingBatchList.as_view(), name='student-mapping-batches'),

    path('add-batch/', student_mapping.AddNewBatchView.as_view(), name='add-new-batch'),

    path('programme-batch-mapping/',           student_mapping.ProgrammeBatchMappingPageLoad.as_view(), name='programme-batch-mapping'),
    path('programme-batch-mapping/first-sem/', student_mapping.ProgrammeBatchMappingFirstSem.as_view(), name='programme-batch-mapping-first-sem'),
    path('programme-batch-mapping/preview/',   student_mapping.ProgrammeBatchMappingPreview.as_view(),  name='programme-batch-mapping-preview'),
    path('programme-batch-mapping/execute/',   student_mapping.ProgrammeBatchMappingExecute.as_view(),  name='programme-batch-mapping-execute'),


    path('college-transfer/', college_centre_transfer.CollegeTransferPageLoad.as_view(),        name='college-transfer'),
    path('college-transfer/fetch/',  college_centre_transfer.CollegeTransferStudentFetch.as_view(),    name='college-transfer-fetch'),
    path('college-transfer/execute/', college_centre_transfer.CollegeTransferExecute.as_view(),         name='college-transfer-execute'),

    path('exam-center-change/fetch/',  college_centre_transfer.ExamCenterChangeFetch.as_view(),   name='exam-center-change-fetch'),
    path('exam-center-change/execute/', college_centre_transfer.ExamCenterChangeExecute.as_view(), name='exam-center-change-execute'),


    path('course-management/',course_management.CourseManagementPageLoad.as_view(),name='course-management'),
    path('course-management/fetch-courses/',course_management.CourseManagementFetchCourses.as_view(),name='course-management-fetch-courses'),
    path('course-management/check-code/',course_management.CourseManagementCheckCode.as_view(),name='course-management-check-code'),
    path('course-management/edit/',course_management.CourseManagementEdit.as_view(),name='course-management-edit'),
    path('course-management/add-with-mapping/',course_management.CourseManagementAddWithMapping.as_view(),name='course-management-add-with-mapping'),
    path('course-management/programme-search/',course_management.CourseManagementProgrammeSearch.as_view(),name='course-management-programme-search'),
    path('course-management/add-with-multi-mapping/',course_management.CourseManagementAddWithMultiMapping.as_view(),name='course-management-add-with-multi-mapping'),
    path('course-management/course-search/', course_management.CourseManagementCourseSearch.as_view(), name='course-management-course-search'),
    path('course-management/map-existing/',course_management.CourseManagementMapExisting.as_view(),name='course-management-map-existing'),
    path('course-management/course-current-mappings/',course_management.CourseManagementCourseCurrentMappings.as_view(),name='course-management-course-current-mappings'),

    path('course-mask/',           course_management.CourseMaskPageLoad.as_view(),    name='course-mask'),
    path('course-mask/mappings/',  course_management.CourseMaskGetMappings.as_view(), name='course-mask-mappings'),
    path('course-mask/execute/',   course_management.CourseMaskExecute.as_view(),     name='course-mask-execute'),
    path('course-mask/unmask/',    course_management.CourseMaskUnmask.as_view(),      name='course-mask-unmask'),
